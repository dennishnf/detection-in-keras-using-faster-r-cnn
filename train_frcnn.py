...
def training(train_path,input_weight_path,parser="pascal_voc",num_rois=32,network= "resnet50",horizontal_flips=False,
                    vertical_flips=False,rot_90 =False,num_epochs=2000,
                    config_filename="config.pickle",output_weight_path='./model_frcnn.hdf5'):
  '''
  ...
  for epoch_num in range(num_epochs):
    ...
    while True:
      try:
        ...
        progbar.update(iter_num+1, [('rpn_cls', losses_[iter_num, 0]), ('rpn_regr', losses_[iter_num, 1]),
                      ('detector_cls', losses_[iter_num, 2]), ('detector_regr', losses_[iter_num, 3])])
